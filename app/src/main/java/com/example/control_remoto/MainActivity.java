...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvtMensaje.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //-------------------------
            }
    ...
    private class ConnectedThread extends Thread
    {
        ...
        {
            try {
                //String repl = Integer.parseInt(input) ;
                //String repl = input.toString();
                //mmOutStream.write(input.getBytes());
                mmOutStream.write(input.getBytes(StandardCharsets.UTF_8));
                //mmOutStream.write(input.charAt());
            }
            catch (IOException e)
            {
